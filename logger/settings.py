...
SECRET_KEY = 'django-insecure-0nbk&(^@151m*e(kvfmc85tz+1-%ribrkkquq7%gzggy(pqnv3'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'qss',  # PostgreSQL'de oluşturduğunuz veritabanı adı
        'USER': 'postgres',  # PostgreSQL kullanıcı adınız
        'PASSWORD': 'umud9999',  # PostgreSQL şifreniz
